...
# terraform-aws-documentdb-cluster [![Latest Release](https://img.shields.io/github/release/hellosaks/terraform-aws-documentdb-cluster.svg)](https://github.com/hellosaks/terraform-aws-documentdb-cluster/releases/latest)
...
module "documentdb_cluster" {
  source = "git::https://github.com/terraform-tools/terraform-aws-documentdb-cluster.git?ref=tags/3.7.0"
  namespace               = "eg"
  stage                   = "testing"
  name                    = "docdb"
  cluster_size            = 3
